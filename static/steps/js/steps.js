...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button id="btnNext" onclick="checklist_aplicacao_visualizar_resumo()"></button>').text(this.options.lang.next).addClass('btn btn-primary btn-lg sw-btn-next rounded mt-3').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button id="btnPrevious" onclick="btnPreviousPress()"></button>').text(this.options.lang.previous).addClass('btn btn-outline-secondary btn-sm sw-btn-prev mt-3').attr('type', 'button') : null;
            var btnFinish = this.options.toolbarSettings.showFinishButton !== false ? $('<button id="btnFinish" onclick="btnFinishPress()"></button>').text(this.options.lang.finish).addClass('btn btn-primary font-weight-semibold btn-lg sw-btn-fin mt-3').attr('type', 'button') : null;
        ...
        _setEvents: function () {
            ...
            $('.sw-btn-fin', this.main).on("click", function (e) {
                e.preventDefault();
                mi._showFinish();
            });
        ...
        _setButtons: function (idx) {
            ...
            if (!this.options.cycleSteps) {
                ...
                if (this.steps.length - 1 <= idx) {
                    ...
                    $('.sw-btn-fin', this.main).removeClass("d-none");
                     $('.sw-btn-prev', this.main).addClass("disabled");
                } else {
                    $('.sw-btn-prev', this.main).addClass("d-none");
                    $('.sw-btn-fin', this.main).addClass("d-none");
                ...
                else if (this.steps.length - 3 === idx)
                {
                    $('.sw-btn-next', this.main).addClass("d-none");
                } else {
        ...
        _fixHeight: function (idx) {
            ...
            if (this.options.autoAdjustHeight) {
                ...
                this.container.finish().animate({ }, this.options.transitionSpeed, function () {});
            }
            return true;
        },
